...
Scanner leia = new Scanner(System.in);
		...
		System.out.println("Escolha a sua faixa estária: ");
		...
		switch(faixaEtaria) {
		case 1: 
			System.out.println("Mensalidade do plano é R$ 100,00");
		break;
		case 2: 
			System.out.println("Mensalidade do plano é R$ 200,00");
		break;
		case 3: 
			System.out.println("Mensalidade do plano é R$ 300,00");
		break;
		case 4: 
			System.out.println("Mensalidade do plano é R$ 500,00");
		break;
		case 5: 
			System.out.println("Mensalidade do plano é R$ 600,00");
		break;
		case 6: 
			System.out.println("Mensalidade do plano é R$ 1000,00");
		break;
		default:
